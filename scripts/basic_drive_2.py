...
This is the same as basic_drive_1.py except it's traveling to a list of goals
instead of one goal. The Jackal should turn to goal N, drive to it, turn to
goal N + 1, drive to it, etc.
"""
...
class SingleGoalNav():
	...
	def __init__(self):
		...
		self.call_jackal_rot_service(720)
